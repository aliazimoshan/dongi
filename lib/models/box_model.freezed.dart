...
mixin _$BoxModel {
  ...
  List<BoxUserModel> get boxUser => throw _privateConstructorUsedError;
...
/// @nodoc
abstract class _$$_BoxModelCopyWith<$Res> implements $BoxModelCopyWith<$Res> {
...
class __$$_BoxModelCopyWithImpl<$Res>
    extends _$BoxModelCopyWithImpl<$Res, _$_BoxModel>
...
class _$_BoxModel implements _BoxModel {
  const _$_BoxModel(
      ...
      final List<BoxUserModel> boxUser = const [],
      this.total = 0,
  ...
  final List<BoxUserModel> _boxUser;
  @override
  @JsonKey()
  List<BoxUserModel> get boxUser {
...
abstract class _BoxModel implements BoxModel {
  const factory _BoxModel(
      ...
      final List<BoxUserModel> boxUser,
      final num? total,
